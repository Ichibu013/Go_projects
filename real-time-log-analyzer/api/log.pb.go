...
const file_log_proto_rawDesc = "" +
	...
	"\terror_msg\x18\x02 \x01(\tR\berrorMsg22\n" +
	"\n" +
	"LogService\x12$\n" +
	"\tIngestLog\x12\r.log.LogEntry\x1a\b.log.AckB\x1cZ\x1areal-time-log-analyzer/apib\x06proto3"
...
var file_log_proto_depIdxs = []int32{
	0, // 0: log.LogService.IngestLog:input_type -> log.LogEntry
	1, // 1: log.LogService.IngestLog:output_type -> log.Ack
